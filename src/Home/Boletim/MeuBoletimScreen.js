...
export default function MeuBoletimScreen() {
  ...
  const renderIcon = (tipo) => {
    switch (tipo) {
      case 'pdf':
        return <FontAwesome name="file-pdf-o" size={24} color="#17322D" />;
      case 'word':
        return <FontAwesome name="file-word-o" size={24} color="#17322D" />;
      // Adicione mais casos conforme necessário para outros tipos de arquivos
      default:
        return <FontAwesome name="file-o" size={24} color="#17322D" />;
    }
  };
